...
public class DoRequestService extends AbstractRequestService{
	...
	public void service(LocalModule module, String[] uris, HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(ThreadContext.getContext() != null && ThreadContext.getContext().getPrincipal() != null) {
			request.put("creator", ThreadContext.getContext().getPrincipal().getName());
			request.put("updator", ThreadContext.getContext().getPrincipal().getName());
		}
